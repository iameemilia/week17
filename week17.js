...
const student = new Student(Oleg, 15, 9);
console.log(student);
...
const student2 = new Student('Ann', 10, 4);
...
const book = new Book("Бородино", "М. Ю. Лермонтов", 1812);
console.log(book);
...
const account = new BankAccount('123456789', 100);
console.log(account);
...
const person = new Person('Аня', 25, 'Москва');
console.log(person);
...
const person2 = new Person('Александр', 21, 'Санкт-Петербург');
person2.changeCity('Сочи');
...
const employee = new Employee('Екатерина', 'Программист', 100000);
...
const employee2 = new Employee('Виктория', 'Учитель', 90000);
...
const product = new Product('Молоко', 100, 2);
console.log(product);
...
const product2 = new Product('Йогурт', 10, 5);
